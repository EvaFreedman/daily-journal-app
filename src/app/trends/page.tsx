...
function buildScoreByDay(entries: JournalEntry[]) {
...
function buildDistribution(entries: JournalEntry[]) {
...
function buildMoodFrequency(entries: JournalEntry[]) {
...
type DayPoint = ReturnType<typeof buildScoreByDay>[number]
